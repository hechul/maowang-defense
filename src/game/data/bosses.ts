...
export const BOSSES: Record<string, BossDef> = {
  captain: {
    ...
    hp: 400, atk: 30, range: 22, spd: 14, atkCd: 0.85, mp: 110, scale: 1.1,
  ...
  archmage: {
    ...
    hp: 1200, atk: 38, range: 100, spd: 14, atkCd: 1.1, mp: 150, scale: 1.1,
  ...
  saint: {
    ...
    hp: 1800, atk: 35, range: 120, spd: 14, atkCd: 1.2, mp: 180, scale: 1.1,
  ...
  king: {
    ...
    hp: 3000, atk: 55, range: 24, spd: 16, atkCd: 0.85, mp: 220, scale: 1.2,
    invuln: { cd: 9, dur: 2 },
    buildSprite: () => pngOrBuild('king_64', () => makeSprite(fallbackBoss('3', 'c'), BOSS_PAL, 2, true), 2),
  },
  priest: {
    id: 'priest', name: '빛의 신관',
    hp: 4000, atk: 80, range: 200, spd: 12, atkCd: 1.4, mp: 260, scale: 1.2,
