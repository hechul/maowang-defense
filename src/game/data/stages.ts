...
export const STAGES: StageDefinition[] = [
  {
    ...
    stageModifier: { heroHpMul: 0.55, heroAtkMul: 0.82, mpRegenMul: 1.05, waveTotalMul: 0.7 },
  ...
  // ===== 챕터 5: 심연의 법정 =====
  {
    ...
    waveLimit: 20,
    heroPool: ['mage', 'healer', 'apprentice', 'archer'],
    bossId: 'priest',
    stratumId: 'abyss_court',
  ...
  },
  {
    ...
    waveLimit: 60,
    heroPool: ['healer', 'shield', 'swordsman', 'mage', 'archer'],
    bossId: 'priest',
    stratumId: 'abyss_court',
  ...
  },
  {
    ...
    waveLimit: 40,
    heroPool: ['healer', 'mage', 'shield', 'archer'],
    bossId: 'saint',
    stratumId: 'abyss_court',
